...
function EnhancedReports() {
  ...
  const handleCreateReport = async () => {
    try {
      ...
      console.log('Backend not available, simulating report creation');
      setCreateReportDialogOpen(false);
      setReportForm({ name: '', description: '', frequency: 'weekly', metrics: [], recipients: '' });
      alert('Custom report created successfully! (Demo mode)');
    }
  };
  ...
  const handleExportReport = async () => {
    try {
      ...
      console.log('Backend not available, simulating export');
      setExportDialogOpen(false);
